    ...
    <div className="space-y-16">
      ...
      >
        ...
        >
          ...
          >
            <button 
              onClick={() => window.open('https://vegas-proceeds-directors-options.trycloudflare.com/', '_blank')}
              className="inline-flex items-center gap-3 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white px-8 py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300"
            >
              <span className="text-2xl">🏠</span>
              {t('home.threeDView')}
            </button>
        ...
        {/* Info text for 3D view */}
        <motion.p
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 0.8, duration: 0.6 }}
          className="text-sm text-slate-500 mt-4 max-w-2xl mx-auto"
        >
          💡 <strong>{t('home.threeDViewHint')}</strong>
        </motion.p>
