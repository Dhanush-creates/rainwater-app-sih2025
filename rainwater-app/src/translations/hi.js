export default {
  ...
  results: {
    ...
    upcomingRainfall: 'आगामी वर्षा पूर्वानुमान',
  ...
  // Rooftop Calculator
  rooftop: {
    title: 'छत क्षेत्र कैलकुलेटर',
    subtitle: 'क्षेत्र की गणना करने के लिए अपनी छत पर क्लिक करें और ड्रॉ करें',
    ...
    instructions: {
      ...
      step1: 'अपना घर खोजने के लिए "मेरा स्थान" पर क्लिक करें',
      step2: 'शुरू करने के लिए "ड्रॉइंग शुरू करें" पर क्लिक करें',
      step3: 'बिंदु बनाने के लिए अपनी छत पर क्लिक करें',
      step4: 'बहुभुज को समाप्त करने के लिए डबल-क्लिक करें',
      step5: 'गणना किए गए क्षेत्र को नीचे देखें'
    },
    areaCalculation: 'क्षेत्र गणना',
    squareMeters: 'वर्ग मीटर',
    squareFeet: 'वर्ग फुट',
    rainwaterPotential: 'वर्षा जल संग्रह क्षमता',
    annualRainfall: 'वार्षिक वर्षा: ~1000mm',
    potentialCollection: 'संभावित संग्रह:',
    litersPerYear: 'लीटर/वर्ष',
    tankRecommendation: 'टैंक आकार सिफारिश',
    threeMonthsStorage: '3 महीने के भंडारण के लिए:',
    liters: 'लीटर',
    tips: {
      title: 'सटीक माप के लिए सुझाव:',
      tip1: 'बेहतर छत दृश्यता के लिए उपग्रह दृश्य का उपयोग करें',
      tip2: 'अपनी छत के किनारों के साथ ड्रॉ करें',
      tip3: 'यदि आपके पास कई स्तर हैं तो सभी छत अनुभागों को शामिल करें',
      tip4: 'सौर पैनल या अन्य संरचनाओं से ढके क्षेत्रों को बाहर करें'
    },
    drawPrompt: 'क्षेत्र गणना देखने के लिए अपनी छत पर ड्रॉ करें',
    mapLoadingError: 'मानचित्र लोडिंग त्रुटि',
    mapErrorDescription: 'Google Maps लोड करने में विफल। कृपया अपनी API कुंजी जांचें।',
    apiRequirements: 'कृपया सुनिश्चित करें कि आपके पास निम्नलिखित API सक्षम के साथ एक वैध Google Maps API कुंजी है:',
    mapsApi: 'Maps JavaScript API',
    drawingLibrary: 'Drawing Library',
    geometryLibrary: 'Geometry Library',
    loadingMap: 'Google Maps लोड हो रहा है...'
  },
  ...
  arPipeline: {
    systemComponents: {
      title: 'सिस्टम घटक',
      collection: 'वर्षा जल संग्रह प्रणाली',
      storage: 'भंडारण प्रणाली',
      distribution: 'वितरण प्रणाली',
      recharge: 'भूजल रिचार्ज'
    }
  },
