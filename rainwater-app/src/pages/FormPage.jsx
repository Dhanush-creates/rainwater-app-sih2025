      ...
      >
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <motion.button 
              onClick={() => window.location.href = '/ar-pipeline'}
              className="bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white px-8 py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-3"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              type="button"
            >
            ...
            <motion.button 
              onClick={() => window.open('https://date-settings-pentium-rss.trycloudflare.com/', '_blank')}
              className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white px-8 py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-3"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              type="button"
            >
        ...
        {/* Info text for buttons */}
        <motion.div
          className="text-center text-sm text-slate-500 mt-4 max-w-2xl mx-auto space-y-2"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 1.3 }}
        >
          <p>💡 <strong>{t('home.threeDViewHint')}</strong></p>
          <p>📸 <strong>AR Pipeline (Artificial Recharge):</strong> Upload house photos to see AI-generated rainwater harvesting system views</p>
        </motion.div>
      </motion.form>
    </motion.div>
  )
